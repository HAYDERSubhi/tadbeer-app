...
Analyze their spending for the current month based on the data provided and generate 2-3 short, actionable, and encouraging tips in Arabic. Speak in a positive and motivational tone.
...
4.  **Format:** The output must be in JSON. The language for title and description must be Arabic.
`,
});
