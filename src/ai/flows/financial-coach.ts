...
Your response MUST STRICTLY follow the persona dictated by the 'appTone' parameter. The currency is Iraqi Dinar (دينار). Do not use any other currency units.
