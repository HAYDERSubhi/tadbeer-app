  ...
  return (
    <div className="bg-background min-h-screen">
        ...
        <div className="p-4 text-center bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300 border-b border-yellow-200 dark:border-yellow-800">
            ...
            <p className="text-sm">تم نقل منطق هذه الصفحة إلى لوحة التحكم الرئيسية. لم تعد هذه الصفحة مستخدمة. <Link href="/" className="underline font-semibold">العودة للرئيسية</Link></p>
        </div>
    </div>
  );
}
