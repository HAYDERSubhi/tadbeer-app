...
import { Loader2Icon, AlertTriangle, User, Mail, LogIn, Lock } from 'lucide-react';
    ...
    <div className="w-full max-w-sm flex flex-col gap-7">
      ...
      <div className="flex flex-col items-center gap-4 text-white text-center">
        ...
        <div>
          ...
          <div className="inline-flex items-center gap-1.5 bg-white/15 text-white/90 text-xs px-3 py-1 rounded-full mt-3">
            <Lock className="h-3 w-3" />
            مجاني تماماً · بياناتك آمنة
          </div>
        </div>
      </div>
